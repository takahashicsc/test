...
class LifelineContactsViewModel @ViewModelInject constructor(private val homeRepository: HomeRepository) :
    ViewModel() {

    val lifelines: StateFlow<List<Me.Lifeline>> get() = _lifelines
    private val _lifelines = MutableStateFlow<List<Me.Lifeline>>(listOf())
    ...
    fun fetch() {
        ...
        viewModelScope.launch {
            ...
            if (response.status == Status.SUCCESS) {
                _lifelines.value = response.data!!.data.lifelines
            } else {
