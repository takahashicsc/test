...
class AccountDetailViewModel @ViewModelInject constructor(private val homeRepository: HomeRepository) :
    ViewModel() {

    val contract: StateFlow<Me.Contract?> get() = _contract
    private val _contract = MutableStateFlow<Me.Contract?>(null)
    ...
    fun fetch() {
        ...
        viewModelScope.launch {
            ...
            if (response.status == Status.SUCCESS) {
                _contract.value = response.data!!.data.contract
            } else {
